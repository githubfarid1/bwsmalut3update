...
def department(request, slug):
    ...
    context = {
        ...
        'slug': slug,
        'satkername': 'PJSA',
        'depurl': 'fm_pjsa_department',
        'deplisturl': 'fm_pjsa_department_list',
        'depyearurl': 'fm_pjsa_department_year',
        'showfolderurl': 'fm_pjsa_show_folder',
    }
...
def folder_list(request):
    ...
    context = {
        ...
        'folder': folder,
        'showfolderurl': 'fm_pjsa_show_folder',
        'downloadurl': 'fm_pjsa_download',
        'slug': slug,
        'year': year,
        'zipfolderurl':'fm_pjsa_download_folder',
        'renameurl': 'fm_pjsa_rename_file',
        'removeurl': 'fm_pjsa_remove_file',
...
def show_folder(request, slug, year):
    ...
    context = {
        ...
        'depurl': 'fm_pjsa_department',
        'deplisturl': 'fm_pjsa_department_list',
        'folderlisturl': 'fm_pjsa_folder_list',
        'downloadurl': 'fm_pjsa_download',
        'depyearurl': 'fm_pjsa_department_year',
        'showfolderurl': 'fm_pjsa_show_folder',
        'addfolderurl': 'fm_pjsa_add_folder',
        'uploadfileurl': 'fm_pjsa_upload_file'
    }
