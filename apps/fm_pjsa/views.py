...
def department(request, slug):
    ...
    if not dep:
        return render(request=request, template_name='fm_pjsa/page_404.html', context={'message':'Halaman tidak ada'})
    ...
    return render(request=request, template_name='fm_pjsa/department.html', context=context)
...
def department_list(request):
    ...
    return render(request=request, template_name='fm_pjsa/department_list.html', context=context)
...
def department_year(request, slug, year):
    ...
    return render(request=request, template_name='fm_pjsa/department_year.html', context=context)
...
def add_department(request):
    ...
    return render(request=request, template_name='fm_pjsa/add_department.html', context=context)
...
def subfolder(request, id):
    ...
    return render(request=request, template_name='fm_pjsa/subfolder.html', context=context)
...
def tagged(request, slug):
    ...
    return render(request, 'fm_pjsa/subfolder.html', context)

@csrf_exempt
def page_404(request):
    return render(request, 'fm_pjsa/page_404.html', {})
